    ...
    <div className="min-h-screen bg-black text-[#E2E8F0]" data-testid="contact-page">
      ...
      <main className="max-w-[1080px] mx-auto px-6 md:px-10 py-16 grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] gap-10">
        <section>
          ...
          <ul className="mt-10 flex flex-col gap-4 text-sm text-[#E2E8F0]/80">
            <li className="border-l-2 border-[#10B981]/60 pl-4">
              <p className="text-[11px] text-[#E2E8F0]/55 tracking-[0.14em]">Technical Support</p>
              <p className="text-white mt-1">
                Account access, invoicing, batch intake or POS billing issues.
              </p>
            </li>
            <li className="border-l-2 border-[#10B981]/60 pl-4">
              <p className="text-[11px] text-[#E2E8F0]/55 tracking-[0.14em]">Partnership Enquiry</p>
              <p className="text-white mt-1">
                Distributor, chain-pharmacy and hospital roll-outs.
              </p>
            </li>
            <li className="border-l-2 border-[#10B981]/60 pl-4">
              <p className="text-[11px] text-[#E2E8F0]/55 tracking-[0.14em]">
        ...
        <section>
          {submitted ? (
            ...
            >
              ...
              <h2 className="font-display text-white text-2xl">Enquiry submitted</h2>
              <p
                className="text-[#E2E8F0]/80 mt-3 max-w-sm"
            ...
            >
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 bg-white text-[#1E2B4E] px-6 py-3 text-sm font-medium hover:bg-[#E2E8F0] active:scale-[0.98] transition-all disabled:opacity-50"
              >
                <Send size={14} />
